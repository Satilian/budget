  ...
  return (
    <div style={{ margin: '0 92px' }}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Family budget, the software
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Family budget.
          </p>
        </li>
        <li>
          <p>
            <strong>Country</strong> refers to: Moldova
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: our.budget.online@gmail.com</li>
      </ul>
    </div>
  );
};
